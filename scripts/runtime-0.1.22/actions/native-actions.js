...
export const NATIVE_ACTION_TYPES = Object.freeze([
  ...
  },
  {
    ...
    description: "Shows an existing JournalEntry or page to all players or selected user IDs where Foundry exposes a show API.",
    dangerLevel: DANGER_LEVELS.DISRUPTIVE,
    rollbackSupported: false,
    requiresConfirmation: true,
    defaultConfig: { journalUuid: "", pageId: "", userIds: [], showToPlayers: true, createChatLinkFallback: true }
  },
  {
