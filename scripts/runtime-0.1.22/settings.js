...
export function registerSettings(onChange) {
  ...
  registerClientSetting(SETTINGS.DIRECTOR_MODE, {
    name: `${MODULE_TITLE}: Director mode`,
    type: String,
    choices: {
      run: "Run",
      plan: "Plan"
  ...
  registerWorldSetting(SETTINGS.ENABLE_AUTOMATION_TRIGGERS, {
    name: `${MODULE_TITLE}: Enable automation Triggers`,
    hint: "Allows armed Beat Triggers to react to Combat, Token, Actor, and round changes.",
    type: Boolean,
    default: true
  });
}
